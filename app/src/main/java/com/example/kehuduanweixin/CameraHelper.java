...
public class CameraHelper {
    ...
    private static final int PREVIEW_WIDTH = 400;                               //预览的宽度
    private static final int PREVIEW_HEIGHT = 400;                             //预览的高度
    private static final int SAVE_WIDTH = 400;                                  //保存图片的宽度
    private static final int SAVE_HEIGHT = 400;                                //保存图片的高度
    private Main9 mActivity;
    private TextureView mTextureView;

    public CameraHelper(Main9 activity, TextureView textureView) {
