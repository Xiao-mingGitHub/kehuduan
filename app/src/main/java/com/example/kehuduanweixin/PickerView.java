...
public class PickerView extends ScrollView {
    ...
    public PickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
             ...
             */
            mWrapContentHeight = mTextHeight * 10;
        } finally {
            a.recycle();
        }
    }
    ...
    private void init() {
        ...
        mLinePaint.setColor(getResources().getColor(R.color.colorx200));
        setPosition(0);
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (tempPosition != position) {
            ...
            for (int i = 0; i < size; i++) {
                 ...
                 */
                if (position +2 == i) {
                    tv.setTextColor(getResources().getColor(R.color.colorText_search));
                } else {
                    tv.setTextColor(getResources().getColor(R.color.colorx200));
                }
            }
        }
