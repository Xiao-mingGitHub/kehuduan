...
public class Main24 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back=(ImageView)findViewById(R.id.main24_bak);
        login=(ImageView)findViewById(R.id.main24_login);
        login.setOnClickListener(this);
        back.setOnClickListener(this);
        xuanzhe=(ImageView)findViewById(R.id.main24_xuanzhe);
        xuanzhe.setOnClickListener(this);
        sharedPreferences = getSharedPreferences("user",MODE_PRIVATE);
        main6_number=(TextView)findViewById(R.id.main24_number);
        main6_name=(TextView)findViewById(R.id.main24_name);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.main24_login:
                editor.putInt("chace",1);
                editor.apply();//提交
                Intent intent = new Intent(Main24.this, Main7.class);
                startActivity(intent);

                finish();
                break;
            case R.id.main24_bak:
                finish();
                break;
            case R.id.main24_xuanzhe:
                if (zt==0){
