...
import com.example.kehuduanweixin.DotView;
...
public class PullScrollView extends ScrollView {
    ...
    private static final float MOVE_SCALE_OPEN_TWO_VIEW = 0.2f;
    //下拉二楼监听器
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if (getScrollY() == 0) {
                        ...
                        tow_view_move_dy = -mScreenHeight + (int) (MOVE_Dy * SCROLL_RATIO);
                        Log.d("gaodu",mScreenHeight+"");
